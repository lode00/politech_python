...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "nQTtY562pVGzkkkBBEBqEmjBe5MA4xSE"
                               }
# 7. Provide the URL to the MapQuest address API.
...
# 10. Provide the ISS key values risetime and duration.
        ...
        durationInSeconds = "per second  API" # -> Because the Current API does not has a response of “second” field in Json, so I choose print a string “per second  API” to replace this.
